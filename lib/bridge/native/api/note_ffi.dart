...
class NoteFfi {
  ...
  NoteFfi._() { _lib = _openLib(); }
  static NoteFfi get instance { _inst ??= NoteFfi._(); return _inst!; }
  ...
  int saveNote(String mediaId, String content) {
    ...
    final r = _lib.lookupFunction<_SaveNoteFn, int Function(Pointer<Utf8>, Pointer<Utf8>)>('amkb_save_note')(m, c);
    calloc.free(m); calloc.free(c); return r;
  }

  int deleteNote(String id) {
    final p = id.toNativeUtf8();
    final r = _lib.lookupFunction<_DeleteNoteFn, int Function(Pointer<Utf8>)>('amkb_delete_note')(p);
